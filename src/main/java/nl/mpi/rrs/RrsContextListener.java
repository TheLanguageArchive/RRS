...
public class RrsContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        setAttributeFromContextParam(sc, RrsConstants.CHECK_EMAIL_SUBJECT_ATTRIBUTE, "Max Planck Institute registration check");
        setAttributeFromContextParam(sc, RrsConstants.CONFIRM_EMAIL_SUBJECT_ATTRIBUTE, "Max Planck Institute registration");
    ...
    private void setAttributeFromContextParam(ServletContext servletContext, String name) {
        setAttributeFromContextParam(servletContext, name, null);
    }

    private void setAttributeFromContextParam(ServletContext servletContext, String name, String defaultValue) {
        String initParamString = getContextParam(servletContext, name);
        if (initParamString == null) {
            initParamString = defaultValue;
        }
        servletContext.setAttribute(name, initParamString);
        logger.debug("Stored into servlet context attribute {}" + name + ": " + initParamString);
    }
     ...
     *
     * @param springConfigPath commaseparated relative paths to multiple
     * spring-config files defining the utilized services
     * @param principalSrv NAME of the (spring-bean) service which implements
