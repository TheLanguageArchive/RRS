    ...
    static {
        try {
            java.util.ResourceBundle bundle =
                    java.util.ResourceBundle.getBundle("nl.mpi.rrs.model.email.mailDefaults");
            ...
            logger.info("DEFAULT_SERVER: " + bundle.getString("DEFAULT_SERVER"));
        } catch (MissingResourceException ex) {
            logger.warn("Email defaults resource bundle is missing");
        }
